...
if operator == "?":
    module.display(module.fib(int(firstNumber)))
elif operator == "!":
    module.display(module.Other(int(firstNumber)))
# Was neither of those so we need a second number
    ...
    if operator == "+":
        module.display(module.Addition(int(firstNumber), int(secondNumber)))
    elif operator == "-":
        module.display(module.Subtraction(int(firstNumber), int(secondNumber)))
    elif operator == "/":
        module.display(module.Division(int(firstNumber), int(secondNumber)))
    elif operator == "*":
        module.display(module.Multiplication(int(firstNumber), int(secondNumber)))
    elif operator == "^":
        module.display(module.Power(int(firstNumber), int(secondNumber)))
    else:
