//Tom Burright
//PLA Every integer is bigger in Texas
//
//
...
int main(void)
{
	int arrayOfInts[5] = { 2, 4, 1, 5, 3 };
	int * array_ptr = &arrayOfInts;

	int arrayOfInts2[5] = { 4, 3, 3, 1, 5 };
	int * array_ptr2 = &arrayOfInts2;

	int numOfElements = 5;
	int *function_ptr = 0;

	function_ptr = &low_to_high_compare;
	printf("low_to_high_compare\n");
	printf("Test1: %d \n", bubble_sort(array_ptr, numOfElements, function_ptr));
	printf("Test2: %d \n\n", bubble_sort(array_ptr2, numOfElements, function_ptr));

	function_ptr = &high_to_low_compare;
	printf("high_to_low_compare\n");
	printf("Test1: %d \n", bubble_sort(array_ptr, numOfElements, function_ptr));
	printf("Test2: %d \n\n", bubble_sort(array_ptr2, numOfElements, function_ptr));

	function_ptr = &absolute_low_to_high_compare;
	printf("absolute_low_to_high_compare\n");
	printf("Test1: %d \n", bubble_sort(array_ptr, numOfElements, function_ptr));
	printf("Test2: %d \n\n", bubble_sort(array_ptr2, numOfElements, function_ptr));

	function_ptr = &absolute_high_to_low_compare;
	printf("absolute_high_to_low_compare\n");
	printf("Test1: %d \n", bubble_sort(array_ptr, numOfElements, function_ptr));
	printf("Test2: %d \n\n", bubble_sort(array_ptr2, numOfElements, function_ptr));
